...
export const openCloseAnimation = trigger('openClose', [
	...
	transition(
		...
		[
			animate(
				...
				keyframes([
					...
					style({ transform: '{{wt50p}}', opacity: 0.5 }),
		...
		],
		{
			params: {
				wt0p: 'translate(0,0)',
				wt25p: 'translate(-25px,25px)',
				wt50p: 'translate(-50px,50px)',
				wt75p: 'translate(-75px,75px)',
				wt100p: 'translate(-100px,100px)',
			},
		}
	),
	transition(
		...
		[
			animate(
				...
				keyframes([
					...
					style({ transform: '{{yAxis50p}}', opacity: 0.5 }),
...
export const minimizeMaximizeAnimation = trigger('minimizeMaximize', [
	state(
		'minimized',
		style({
			opacity: 1,
