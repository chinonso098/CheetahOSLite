...
export class DesktopComponent implements OnInit, OnDestroy, AfterViewInit{
  ...
  buildNewMenu(): NestedMenuItem[]{
    ...
    const newFolder:NestedMenuItem={ icon:'osdrive/icons/empty_folder.ico', label:'Folder',  action: ()=>'',  variables:true , 
  ...
  getDesktopMenuData():void{
    this.deskTopMenu = [
          ...
          {icon1:'/osdrive/icons/camera_48.png', icon2:'', label:'Screen Shot', nest:[], action:()=> '', action1: ()=> '', emptyline:false},
