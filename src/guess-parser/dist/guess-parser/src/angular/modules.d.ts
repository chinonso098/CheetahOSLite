...
export declare const collectRoutingModules: (
	rootFile: string,
	registry: Registry,
...
export declare const getModulePathFromRoute: (
	parentPath: string,
	loadChildren: string,
	program: ts.Program,
...
export declare const getModuleEntryPoint: (
	path: string,
	entryPoints: Set<string>,
	program: ts.Program,
	host: ts.CompilerHost
) => string;
export declare const getLazyEntryPoints: (
